...
object OpenID {
    ...
    object ResponseMode {
         ...
         * being encoded in the body using the application/x-www-form-urlencoded format. The action attribute of the
         * form MUST be the Client's Redirection URI. The method of the form attribute MUST be POST. Because the
         * Authorization Response is intended to be used only once, the Authorization Server MUST instruct the User
         * Agent (and any intermediaries) not to store or reuse the content of the response.
         *
         * Any technique supported by the User Agent MAY be used to cause the submission of the form, and any form
         * content necessary to support this MAY be included, such as submit controls and client-side scripting
         * commands. However, the Client MUST be able to process the message without regard for the mechanism by which
         * the form submission was initiated.
         */
